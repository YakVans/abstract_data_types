...
TEST_CASE("test_segmented_array_sequence_mutable_constructor") {
    MutableSegmentedArraySequence<int> seq1;
    CHECK(seq1.GetLength() == 0);

    int values[] = {4, 0, 56, -2, 9};
    MutableSegmentedArraySequence<int> seq3(values, 5);
    CHECK(seq3.GetLength() == 5);
    for (int i = 0; i < 5; i++) {
        CHECK(seq3.Get(i) == values[i]);
    }

    MutableSegmentedArraySequence<int> seq4(seq3);
...
TEST_CASE("test_segmented_array_sequence_mutable_copy_independence") {
    int values[] = {4, 0, 56, -2, 9};
    MutableSegmentedArraySequence<int> seq1(values, 5);
    MutableSegmentedArraySequence<int> seq2(seq1);
    seq1.Set(2, 14);
    CHECK(seq2.Get(2) == 56);
}

TEST_CASE("test_segmented_array_sequence_mutable_getter") {
    int values[] = {4, 0, 56, -2, 9};
    MutableSegmentedArraySequence<int> seq(values, 5);
    ...
    MutableSegmentedArraySequence<int> empty_seq;
...
TEST_CASE("test_segmented_array_sequence_mutable_get_subsequence") {
    int values[] = {4, 0, 56, -2, 9};
    MutableSegmentedArraySequence<int> seq(values, 5);
...
TEST_CASE("test_segmented_array_sequence_mutable_set") {
    int values[] = {4, 0, 56, -2, 9};
    int values1[] = {-12, 13, 21, -2, 9};
    MutableSegmentedArraySequence<int> seq(values1, 5);
    for (int i = 1; i < 4; i++) {
        seq.Set(i, values[i]);
    }
    for (int i = 1; i < 4; i++) {
...
TEST_CASE("test_segmented_array_sequence_mutable_append") {
    MutableSegmentedArraySequence<int> seq;
...
TEST_CASE("test_segmented_array_sequence_mutable_prepend") {
    MutableSegmentedArraySequence<int> seq;
...
TEST_CASE("test_segmented_array_sequence_mutable_insert_at") {
    int values[] = {4, 0, 56, -2, 9};
    MutableSegmentedArraySequence<int> seq;
...
TEST_CASE("test_segmented_array_sequence_mutable_remove_at") {
    int values[] = {4, 0, 56, -2, 9};
    MutableSegmentedArraySequence<int> seq(values, 5);
...
TEST_CASE("test_segmented_array_sequence_mutable_concat_in_place") {
    int values1[] = {4, 0, 56, -2, 9};
    int values2[] = {42, -5, 3, 1};
    MutableSegmentedArraySequence<int> seq1(values1, 5);
    MutableSegmentedArraySequence<int> seq2(values2, 4);
...
TEST_CASE("test_segmented_array_sequence_mutable_concat_in_place_with_self") {
    int values1[] = {4, 0, 56, -2, 9};
    MutableSegmentedArraySequence<int> seq1(values1, 5);
...
TEST_CASE("test_segmented_array_sequence_map_where_reduce") {
    int values[] = {4, 0, 56, -2, 9};
    MutableSegmentedArraySequence<int> arr(values, 5);
...
TEST_CASE("test_segmented_array_sequence_call_chaining") {
    int values[] = {4, 0, 56, -2, 9};
    MutableSegmentedArraySequence<int> arr(values, 5);
