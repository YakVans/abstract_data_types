...
TEST_CASE("test_segmented_array_sequence_immutable_constructor") {
    ImmutableSegmentedArraySequence<int> seq1;
    CHECK(seq1.GetLength() == 0);

    int values[] = {4, 0, 56, -2, 9};
    ImmutableSegmentedArraySequence<int> seq3(values, 5);
    CHECK(seq3.GetLength() == 5);
    for (int i = 0; i < 5; i++) {
        CHECK(seq3.Get(i) == values[i]);
    }

    ImmutableSegmentedArraySequence<int> seq4(seq3);
...
TEST_CASE("test_segmented_array_sequence_immutable_getter") {
    int values[] = {4, 0, 56, -2, 9};
    ImmutableSegmentedArraySequence<int> seq(values, 5);
    ...
    ImmutableSegmentedArraySequence<int> empty_seq;
...
TEST_CASE("test_segmented_array_sequence_immutable_get_subsequence") {
    int values[] = {4, 0, 56, -2, 9};
    ImmutableSegmentedArraySequence<int> seq(values, 5);

    SegmentedArraySequence<int> *sub_seq = seq.GetSubSequence(1, 4);
    ...
    SegmentedArraySequence<int> *single_seq = seq.GetSubSequence(1, 2);
...
TEST_CASE("test_segmented_array_sequence_immutable_set") {
    int values[] = {4, 0, 56, -2, 9};
    int values1[] = {-12, 13, 21, -2, 9};

    ImmutableSegmentedArraySequence<int> seq1(values, 5);

    SegmentedArraySequence<int> *seq2 = seq1.Set(0, -12);

    SegmentedArraySequence<int> *seq3 = seq2->Set(2, 21);
    
    SegmentedArraySequence<int> *seq4 = seq3->Set(1, 13);
...
TEST_CASE("test_segmented_array_sequence_immutable_append") {
    ImmutableSegmentedArraySequence<int> seq;

    SegmentedArraySequence<int> *seq1 = seq.Append(-3);
    CHECK(seq1->GetLength() == 1);
    CHECK(seq1->Get(0) == -3);
    CHECK(seq1->GetFirst() == -3);
    CHECK(seq1->GetLast() == -3);

    SegmentedArraySequence<int> *seq2 = seq1->Append(56);
...
TEST_CASE("test_segmented_array_sequence_immutable_prepend") {
    ImmutableSegmentedArraySequence<int> seq;

    SegmentedArraySequence<int> *seq1 = seq.Prepend(-3);
    CHECK(seq1->GetLength() == 1);
    CHECK(seq1->Get(0) == -3);
    CHECK(seq1->GetFirst() == -3);
    CHECK(seq1->GetLast() == -3);

    SegmentedArraySequence<int> *seq2 = seq1->Prepend(56);
    CHECK(seq2->GetLength() == 2);
    CHECK(seq2->Get(0) == 56);
    CHECK(seq2->Get(1) == -3);
...
TEST_CASE("test_segmented_array_sequence_immutable_insert_at") {
    int values[] = {4, 0, 56, -2, 9};
    ImmutableSegmentedArraySequence<int> seq;

    SegmentedArraySequence<int> *seq1 = seq.InsertAt(0, 0);
    CHECK(seq1->GetLength() == 1);
    CHECK(seq1->Get(0) == values[1]);

    SegmentedArraySequence<int> *seq2 = seq1->InsertAt(1, 56);
    CHECK(seq2->GetLength() == 2);
    CHECK(seq2->Get(0) == values[1]);
    CHECK(seq2->Get(1) == values[2]);

    SegmentedArraySequence<int> *seq3 = seq2->InsertAt(2, 9);
    CHECK(seq3->GetLength() == 3);
    CHECK(seq3->Get(0) == values[1]);
    CHECK(seq3->Get(1) == values[2]);
    CHECK(seq3->Get(2) == values[4]);

    SegmentedArraySequence<int> *seq4 = seq3->InsertAt(2, -2);
    ...
    SegmentedArraySequence<int> *seq5 = seq4->InsertAt(0, 4);
...
TEST_CASE("test_segmented_array_sequence_immutable_remove_at") {
    int values[] = {4, 0, 56, -2, 9};
    ImmutableSegmentedArraySequence<int> seq(values, 5);
    ...
    SegmentedArraySequence<int> *seq1 = seq.RemoveAt(0);
    ...
    SegmentedArraySequence<int> *seq2= seq1->RemoveAt(3);
    CHECK(seq2->GetLength() == 3);
    CHECK(seq2->Get(0) == values[1]);
    CHECK(seq2->Get(1) == values[2]);
    CHECK(seq2->Get(2) == values[3]);

    SegmentedArraySequence<int> *seq3 = seq2->RemoveAt(1);
    CHECK(seq3->GetLength() == 2);
    CHECK(seq3->Get(0) == values[1]);
    CHECK(seq3->Get(1) == values[3]);

    SegmentedArraySequence<int> *seq4 = seq3->RemoveAt(1);
    CHECK(seq4->GetLength() == 1);
    CHECK(seq4->Get(0) == values[1]);

    SegmentedArraySequence<int> *seq5 = seq4->RemoveAt(0);
...
TEST_CASE("test_segmented_array_sequence_immutable_concat") {
    int values1[] = {4, 0, 56, -2, 9};
    int values2[] = {42, -5, 3, 1};
    ImmutableSegmentedArraySequence<int> seq1(values1, 5);
    ImmutableSegmentedArraySequence<int> seq2(values2, 4);


    SegmentedArraySequence<int> *seq3 = seq1.Concat(seq2);
    ...
    SegmentedArraySequence<int> *seq4 = seq2.Concat(empty_seq);
    ...
    SegmentedArraySequence<int> *seq5 = empty_seq.Concat(seq2);
...
TEST_CASE("test_segmented_array_sequence_map_where_reduce") {
    int values[] = {4, 0, 56, -2, 9};
    ImmutableSegmentedArraySequence<int> seq(values, 5);

    int map_values[] = {8, 0, 112, -4, 18};
    SegmentedArraySequence<int> *seq1 = seq.Map(map_example1);
    for (int i = 0; i < 5; i++) {
        CHECK(seq1->Get(i) == map_values[i]);
    }

    int where_values[] = {8, 112, 18};
    SegmentedArraySequence<int> *seq2 = seq1->Where(where_example1);
