...
TEST_CASE("test_doubly_linked_list_constructor") {
    DoublyLinkedList<int> list1;
    CHECK(list1.GetLength() == 0);

    int values[] = {4, 0, 56, -2, 9};
    DoublyLinkedList<int> list3(values, 5);
...
TEST_CASE("test_doubly_linked_list_copy_independence") {
    int values[] = {4, 0, 56, -2, 9};
    DoublyLinkedList<int> list1(values, 5);
    DoublyLinkedList<int> list2(list1);
    list1.Set(2, 14);
    CHECK(list2.Get(2) == 56);
}

TEST_CASE("test_doubly_linked_list_getter") {
    int values[] = {4, 0, 56, -2, 9};
    DoublyLinkedList<int> list(values, 5);
...
TEST_CASE("test_doubly_linked_list_get_sublist") {
    int values[] = {4, 0, 56, -2, 9};
    DoublyLinkedList<int> list(values, 5);

    DoublyLinkedList<int> *sub_list = list.GetSubList(1, 4);
    ...
    DoublyLinkedList<int> *single_list = list.GetSubList(1, 2);
...
TEST_CASE("test_doubly_linked_list_set") {
    int values[] = {4, 0, 56, -2, 9};
...
TEST_CASE("test_doubly_linked_list_append") {
...
TEST_CASE("test_doubly_linked_list_prepend") {
    DoublyLinkedList<int> list;
...
TEST_CASE("test_doubly_linked_list_insert_at") {
    int values[] = {4, 0, 56, -2, 9};
    DoublyLinkedList<int> list;
...
TEST_CASE("test_doubly_linked_list_remove_at") {
    int values[] = {4, 0, 56, -2, 9};
    DoublyLinkedList<int> list(values, 5);
...
TEST_CASE("test_doubly_linked_list_concat_in_place") {
    int values1[] = {4, 0, 56, -2, 9};
    int values2[] = {42, -5, 3, 1};
    DoublyLinkedList<int> list1(values1, 5);
    DoublyLinkedList<int> list2(values2, 4);
...
TEST_CASE("test_doubly_linked_list_concat_in_place_with_self") {
    int values1[] = {4, 0, 56, -2, 9};
    DoublyLinkedList<int> list1(values1, 5);
...
TEST_CASE("test_doubly_linked_list_map_where_reduce") {
    int values[] = {4, 0, 56, -2, 9};
    DoublyLinkedList<int> list(values, 5);
...
TEST_CASE("test_doubly_linked_list_call_chaining") {
    int values[] = {4, 0, 56, -2, 9};
    DoublyLinkedList<int> list(values, 5);
...
TEST_CASE("test_doubly_linked_list_is_sublistay") {
    int values[] = {4, 0, 56, -2, 9};
    ...
    DoublyLinkedList<int> list(values, 5);
    DoublyLinkedList<int> start_list(start_values, 3);
    DoublyLinkedList<int> end_list(end_values, 1);
    DoublyLinkedList<int> wrong_list(wrong_values, 3);
    DoublyLinkedList<int> empty_list(values, 0);
    DoublyLinkedList<int> larger_list(larger_values, 6);
...
TEST_CASE("test_doubly_linked_list_sort") {
    int values[] = {4, 0, 56, -2, 9};
    ...
    CHECK(list.GetLength() == 5);
    for (int i = 0; i < 5; i++) {
        CHECK(list.Get(i) == svalues[i]);
    }

    DoublyLinkedList<int> sorted_list(sorted_values, 3);
    sorted_list.Sort();
    CHECK(sorted_list.GetLength() == 3);
    for (int i = 0; i < 3; i++) {
        CHECK(sorted_list.Get(i) == sorted_values[i]);
    }

    DoublyLinkedList<int> rev_sorted_list(rev_sorted_values, 3);
    rev_sorted_list.Sort();
    CHECK(rev_sorted_list.GetLength() == 3);
    for (int i = 0; i < 3; i++) {
        CHECK(rev_sorted_list.Get(i) == sorted_values[i]);
    }

    DoublyLinkedList<int> single_list(single_values, 1);
    single_list.Sort();
    CHECK(single_list.GetLength() == 1);
    CHECK(single_list.Get(0) == 9);
...
TEST_CASE("test_doubly_linked_list_count_inversions") {
    int values1[] = {1, 2, 3, 4, 5};
    DoublyLinkedList<int> list1(values1, 5);
    CHECK(list1.CountInversions() == 0);

    int values2[] = {1, 3, 2, 4, 5};
    DoublyLinkedList<int> list2(values2, 5);
    CHECK(list2.CountInversions() == 1);

    int values3[] = {5, 4, 3, 2, 1};
    DoublyLinkedList<int> list3(values3, 5);
    ...
    int values5[] = {2, 1};
    DoublyLinkedList<int> list5(values5, 2);
    CHECK(list5.CountInversions() == 1);

    int values6[] = {1};
    DoublyLinkedList<int> list6(values6, 1);
