            ...
            if (operation == 0) {
                ...
                switch (operation) {
                    ...
                    case 5: {
                        ...
                        Deque<T> *subdeque = deque->GetSubDeque(indexes->Get(0), indexes->Get(1));
                    ...
                    case 6: {
                        std::cout << "Subdeque: ";
                        Deque<T> *subdeque = CreationUI<MutableDeque<T>, T>();
                        if (deque->IsSubDeque(subdeque)) std::cout << "Include this\n";
                    ...
                    case 7: {
                        ...
                        if (deque->MutType() == mut) {
                            ...
                            Deque<T> *new_deque = deque->push_back(value);
                    ...
                    case 8: {
                        ...
                        if (deque->MutType() == mut) {
                            ...
                            Deque<T> *new_deque = deque->push_front(value);
                            if (SaveOrNot(new_deque)) {
                                delete deque;
                                deque = new_deque;
                            }
                    ...
                    case 9: {
                        ...
                        if (deque->MutType() == mut) {
                            ...
                            Deque<T> *new_deque = deque->pop_back();
                            if (SaveOrNot(new_deque)) {
                                delete deque;
                                deque = new_deque;
                            }
                    ...
                    case 10: {
                        ...
                        if (deque->MutType() == mut) {
                            ...
                            Deque<T> *new_deque = deque->pop_front();
                            if (SaveOrNot(new_deque)) {
                                delete deque;
                                deque = new_deque;
                            }
                    ...
                    case 11: {
                        if (deque->MutType() == mut) {
                            MapUI<Deque<T>, T>(deque);
                        }
                        else {
                            Deque<T> *new_deque = MapUI<Deque<T>, T>(deque);
                            if (SaveOrNot(new_deque)) {
                                delete deque;
                                deque = new_deque;
                            }
                    ...
                    case 12: {
                        if (deque->MutType() == mut) {
                            WhereUI<Deque<T>, T>(deque);
                        }
                        else {
                            Deque<T> *new_deque = WhereUI<Deque<T>, T>(deque);
                            if (SaveOrNot(new_deque)) {
                                delete deque;
                                deque = new_deque;
                            }
                    ...
                    case 13: {
                        std::cout << "Reduced: " << ReduceUI<Deque<T>, T>(deque) << "\n";
                        break;
                    }
                    case 14: {
                        if (deque->MutType() == mut) {
                            deque = ConcatUI<Deque<T>, T>(deque);
                        }
                        else {
                            Deque<T> *new_deque = ConcatUI<Deque<T>, T>(deque);
                            if (SaveOrNot(new_deque)) {
                                delete deque;
                                deque = new_deque;
                            }
